...
var tagRegex = /^[0-9a-z_\(\)-]+$/i
    //Make unique
    , aUnique = function(a){var b={},c,d=a.length,e=[];for(c=0;c<d;c+=1)b[a[c]]=a[c];for(c in b)if(b.hasOwnProperty(c))e.push(b[c]);return e;};
...
module.exports = function(app){
    ...
    app.post('/s/comment/:id', function(req, res) {
        if (!req.isAuthenticated()) {
            ...
            app.providers.commentProvider.add(req.param('id'), comment, function(error){
